        ...
        <Header/>
            ...
            <main className={styles.main}>
                <section className={styles.banner}>
                    ...
                    <div>
                        <img className={styles['banner-image']} src={"staticImages/banner-image.svg"} alt={'banner image'}/>
                    </div>
                </section>
                ...
                <section className={styles['faq-section']}>
                    ...
                    <div className={styles['faq-list-articles-flex-container']}>
                        <article id={'contests'}>
                            ...
                            {faqFirstArticle.map((faq, index)=> <OutgoingCard key={index} id={index} answer={faq.answer} question={faq.question}/>)}
                        </article>
                        <article id={'marketplace'}>
                            <h3 className={styles['faq-list-header']}>Buying From Marketplace</h3>
                            {faqSecondArticle.map((faq, index)=> <OutgoingCard key={index} id={index} answer={faq.answer} question={faq.question}/>)}
                        </article>
                        <article id={'managed'}>
                            <h3 className={styles['faq-list-header']}>Managed Contests</h3>
                            {faqThirdArticle.map((faq, index)=> <OutgoingCard key={index} id={index} answer={faq.answer} question={faq.question}/>)}
                        </article>
                        <article id={'creatives'}>
                            <h3 className={styles['faq-list-header']}>For Creatives</h3>
                            {faqFourthArticle.map((faq, index)=> <OutgoingCard key={index} id={index} answer={faq.answer} question={faq.question}/>)}
                        </article>
            ...
            <section className={styles['cta-section']}>
                ...
                <button className={styles['cta-section-btn']}>Start A Contest</button>
            </section>

            <section className={styles['stats-section']}>
                <article className={styles['stats-container']}>
                    <StatsCard iconSrc={'staticImages/stars.svg'}>
                        {({boldStyles, textStyles}) => <p className={textStyles}><span className={boldStyles}>4.9 out of 5 stars</span> from 25,000+ customers.</p>}
                    </StatsCard>
                    <StatsCard iconSrc={'staticImages/img2-for-stats.webp'}>
                        {({boldStyles, textStyles}) => <p className={textStyles}> Our branding community stands<span className={boldStyles}> 200,000+</span> strong.</p>}
                    </StatsCard>
                    <StatsCard iconSrc={'staticImages/sharing-files.svg'}>
                        {({boldStyles, textStyles}) => <p className={textStyles}><span className={boldStyles}>140+</span> Industries supported across more than <span className={boldStyles}>85</span> countries – and counting.</p>}
                    </StatsCard>
                </article>
            </section>
            ...
            <section className={styles['pricing-section']}>
                        ...
                        {({headerStyles, textStyles, arrowStyles}) => (
                            <>
                                ...
                                <div>
                                    ...
                                    <p className={textStyles}>For as low as $199, our naming contests and marketplace allow you to get an amazing brand quickly and affordably.</p>
                                </div>
                            </>)}
                    </PricingCard>
                        ...
                        {({headerStyles, textStyles, arrowStyles}) => (
                            <>
                                ...
                                <div>
                                    ...
                                    <p className={textStyles}>Of course! We have policies in place to ensure that you are satisfied with your experience. <a href={'#'}>Learn more</a></p>
                                </div>
                            </>
                        )}
                    </PricingCard>
                ...
                <div className={styles['info-container']}>
                    ...
                    <button className={styles['info-container-button']}>Schedule Consultation</button>
